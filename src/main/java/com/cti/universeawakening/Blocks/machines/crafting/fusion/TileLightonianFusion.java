...
public class TileLightonianFusion extends TileEntity implements INamedContainerProvider, ITickableTileEntity {}
    ...
    private FusionZoneContents fuelZoneContents;
    private FusionZoneContents inputZoneContents;
    private FusionZoneContents outputZoneContents;


    private final FusionStateData furnaceStateData = new FusionStateData();

    public TileLightonianFusion(){
        super(RegistryHandler.FusionCore);
        fuelZoneContents = FusionZoneContents.createForTileEntity(FUEL_SLOTS_COUNT,
                this::canPlayerAccessInventory, this::markDirty);
        inputZoneContents = FusionZoneContents.createForTileEntity(INPUT_SLOTS_COUNT,
                this::canPlayerAccessInventory, this::markDirty);
        outputZoneContents = FusionZoneContents.createForTileEntity(OUTPUT_SLOTS_COUNT,
                this::canPlayerAccessInventory, this::markDirty);
    }
     ...
     */
    public boolean willItemStackFit(FusionZoneContents furnaceZoneContents, int slotIndex, ItemStack itemStackOrigin) {
...
//	//  it uses getUpdatePacket(), getUpdateTag(), onDataPacket(), and handleUpdateTag() to do this
    ...
    public ITextComponent getDisplayName() {
        return new TranslationTextComponent("container.uniberseawakening.fusion.fusionname");
    }
    ...
    public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        return ContainerFusion.createContainerServerSide(windowID, playerInventory,
