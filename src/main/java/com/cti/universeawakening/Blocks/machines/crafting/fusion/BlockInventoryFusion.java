...
public class BlockInventoryFusion extends ContainerBlock
{
    public BlockInventoryFusion()
    {
    ...
    public TileEntity createNewTileEntity(IBlockReader worldIn) {
        return new TileLightonianFusion();
    }
    ...
    public void onReplaced(BlockState state, World world, BlockPos blockPos, BlockState newState, boolean isMoving) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (tileentity instanceof TileLightonianFusion) {
                TileLightonianFusion tileEntityFurnace = (TileLightonianFusion)tileentity;
