package com.cti.universeawakening.server;
...
public class LightonianFurnaceServerConfig {
    ...
    static {
        ...
        builder.comment("Options that affect the lightonian furnace.").push("Furnace Settings");
        VANILLA_RECIPES_ENABLED = builder
                .comment("If enabled, the vanilla blasting, smelting, and smoking recipes are used by the lightonian furnace.")
                .define("vanillaRecipesEnabled", false);
        COOK_TIME_FACTOR = builder
                .comment("Cook time factor of the lightonian furnace in relation to corresponding vanilla furnaces. (i. e. 0.5 - half the time, 1.0 same time, 2.0 twice the time)")
                .defineInRange("cookTimeFactor", 0.1, 0.0, 0.0);
